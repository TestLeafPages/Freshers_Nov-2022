...
public static void main(String[] args) {
	...
	driver.manage().window().maximize();
     ...
     //builder.keyDown(Keys.CONTROL).click(ele1).click(ele2).click(ele3).click(ele4)
     //.click(ele5).click(ele6).keyUp(Keys.CONTROL).perform();
	//builder.clickAndHold(ele1).moveToElement(ele6).release().perform();
     
	builder.keyDown(Keys.CONTROL).click(ele1).click(ele3)
    .click(ele6).keyUp(Keys.CONTROL).perform();
